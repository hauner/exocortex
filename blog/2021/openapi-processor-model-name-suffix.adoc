...
apart from a couple of bug fixes and improvements for multipart request and bean-validations, openapi-processor is now able to automatically add a suffix to the generated model classes.
